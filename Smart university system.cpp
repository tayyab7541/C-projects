...
class student:public User  //first child class
{
     ...
     {
    cout<<"Name of stduent is = "<<name<<endl<<"Id of student = "<<id<<endl<<"Fee of student = "<<fee<<endl<<"semester of student = "<<semester<<endl;
...
class teacher:public User  //this is second child class
{
    ...
    void displayinfo() //overriding pure virtual function
    {
     cout<<"Name of teacher = "<<name<<endl<<"Id of teacher = "<<id<<endl<<"Years of experience = "<<year_of_experience<<endl<<"Pay of teacher = "<<pay<<endl;
    }
};
...
class course
{
    protected:
            ...
            {
                st<<"Name = "<<c.name<<endl<<"Id = "<<c.id<<"\n Fee is = "<<c.fee<<endl<<"semester = "<<c.semester<<endl;
                return st;
            }
...

{
    ...
    do
    {
        ...
        else if(num==2)
        {
            ...
            tech.inputinfo();
            int check;
            cout<<"if you want to display info press 1: ";
            cin>>check;
            if(check==1)
            {
            tech.displayinfo();
        ...
        {
             calculator<int>  cu; // creating object of claculator class with int data type
             cu.input();
        }
